...
/**
  ...
  */
bindingSet: import('../Gtk').BindingSet;
/**
...
/**
  * implementation detail 
  */
hashNext: import('../Gtk').BindingEntry;
/**
  * implementation detail 
  */
inEmission: number;
...
/**
  ...
  */
modifiers: import('../Gdk').ModifierType;
/**
  * linked list of entries maintained by binding set 
  */
setNext: import('../Gtk').BindingEntry;
/**
  * action signals of this entry 
  */
signals: import('../Gtk').BindingSignal;
}
