...
for a given Gtk.TreeModel row. 
  */
export declare class CellArea extends import('../GObject').InitiallyUnowned, import('../Gtk').Buildable, import('../Gtk').CellLayout{
/**
...
/**
  ...
  */
editWidget: import('../Gtk').CellEditable;
/**
  * The cell which is currently being edited 
  */
editedCell: import('../Gtk').CellRenderer;
/**
...
/**
  *   
  */
parentInstance: import('../GObject').InitiallyUnowned;
}
