...
interfaces. 
  */
export declare class TreeStore extends import('../GObject').Object, import('../Gtk').Buildable, import('../Gtk').TreeDragDest, import('../Gtk').TreeDragSource, import('../Gtk').TreeModel, import('../Gtk').TreeSortable{
/**
