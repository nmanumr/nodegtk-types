...
interfaces. 
  */
export declare class ListStore extends import('../GObject').Object, import('../Gtk').Buildable, import('../Gtk').TreeDragDest, import('../Gtk').TreeDragSource, import('../Gtk').TreeModel, import('../Gtk').TreeSortable{
/**
