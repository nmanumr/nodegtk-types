...
inInotify: number;
/**
  * Indicates whether the closure is currently being invoked with GObject.Closure.invoke() 
  */
inMarshal: number;
/**
  * Indicates whether the closure has been invalidated by GObject.Closure.invalidate() 
  */
isInvalid: number;
/**
  *   
...
/**
  *   
  */
notifiers: import('../GObject').ClosureNotifyData;
/**
  *   
  */
refCount: number;
