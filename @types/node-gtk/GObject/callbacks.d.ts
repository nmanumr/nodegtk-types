/**
  ...
  */
export declare function baseFinalizeFunc(gClass: import('../GObject').TypeClass): void;
/**
  ...
  */
export declare function baseInitFunc(gClass: import('../GObject').TypeClass): void;
/**
  ...
  */
export declare function bindingTransformFunc(binding: import('../GObject').Binding, fromValue: import('../GObject').Value, toValue: import('../GObject').Value, userData: Object | null): boolean;
/**
  ...
  */
export declare function boxedCopyFunc(boxed: Object): Object;
/**
  ...
  */
export declare function boxedFreeFunc(boxed: Object): void;
/**
...
/**
  ...
  */
export declare function classFinalizeFunc(gClass: import('../GObject').TypeClass, classData: Object | null): void;
/**
  ...
  * @param classData The class_data member supplied via the GObject.TypeInfo structure. 
  */
export declare function classInitFunc(gClass: import('../GObject').TypeClass, classData: Object | null): void;
/**
  ...
  */
export declare function closureMarshal(closure: import('../GObject').Closure, returnValue: import('../GObject').Value | null, paramValues: import('../GObject').Value, invocationHint: Object | null, marshalData: Object | null): void;
/**
  ...
  */
export declare function closureNotify(data: Object | null, closure: import('../GObject').Closure): void;
/**
  ...
  */
export declare function instanceInitFunc(instance: import('../GObject').TypeInstance, gClass: import('../GObject').TypeClass): void;
/**
  ...
  */
export declare function interfaceFinalizeFunc(gIface: import('../GObject').TypeInterface, ifaceData: Object | null): void;
/**
  ...
  * @param ifaceData The interface_data supplied via the GObject.InterfaceInfo structure 
  */
export declare function interfaceInitFunc(gIface: import('../GObject').TypeInterface, ifaceData: Object | null): void;
/**
  * The type of the finalize function of GObject.ObjectClass.
  * @param object the GObject.Object being finalized 
  */
export declare function objectFinalizeFunc(object: import('../GObject').Object): void;
/**
  ...
  */
export declare function objectGetPropertyFunc(object: import('../GObject').Object, propertyId: number, value: import('../GObject').Value, pspec: import('../GObject').ParamSpec): void;
/**
  ...
  * @param pspec the GObject.ParamSpec describing the property 
  */
export declare function objectSetPropertyFunc(object: import('../GObject').Object, propertyId: number, value: import('../GObject').Value, pspec: import('../GObject').ParamSpec): void;
/**
  ...
  */
export declare function signalAccumulator(ihint: import('../GObject').SignalInvocationHint, returnAccu: import('../GObject').Value, handlerReturn: import('../GObject').Value, data: Object | null): boolean;
/**
  ...
  */
export declare function signalEmissionHook(ihint: import('../GObject').SignalInvocationHint, paramValues: import('../GObject').Value, data: Object | null): boolean;
/**
  ...
  */
export declare function toggleNotify(data: Object | null, object: import('../GObject').Object, isLastRef: boolean): void;
/**
  ...
  */
export declare function typeClassCacheFunc(cacheData: Object | null, gClass: import('../GObject').TypeClass): boolean;
/**
  ...
  */
export declare function typeInterfaceCheckFunc(checkData: Object | null, gIface: import('../GObject').TypeInterface): void;
/**
  ...
  */
export declare function typePluginCompleteInterfaceInfo(plugin: import('../GObject').TypePlugin, instanceType: import('../GObject').GType, interfaceType: import('../GObject').GType, info: import('../GObject').InterfaceInfo): void;
/**
  ...
  */
export declare function typePluginCompleteTypeInfo(plugin: import('../GObject').TypePlugin, gType: import('../GObject').GType, info: import('../GObject').TypeInfo, valueTable: import('../GObject').TypeValueTable): void;
/**
  ...
  */
export declare function typePluginUnuse(plugin: import('../GObject').TypePlugin): void;
/**
  ...
  */
export declare function typePluginUse(plugin: import('../GObject').TypePlugin): void;
/**
  ...
  */
export declare function valueTransform(srcValue: import('../GObject').Value, destValue: import('../GObject').Value): void;
/**
  ...
  */
export declare function weakNotify(data: Object | null, whereTheObjectWas: import('../GObject').Object): void;
