/**
  ...
  */
export declare function eventFunc(event: import('../Gdk').Event, data: Object | null): void;
/**
  ...
  */
export declare function filterFunc(xevent: Object, event: import('../Gdk').Event, data: Object | null): import('../Gdk').FilterReturn;
/**
  ...
  */
export declare function seatGrabPrepareFunc(seat: import('../Gdk').Seat, window: import('../Gdk').Window, userData: Object | null): void;
/**
  ...
  */
export declare function windowChildFunc(window: import('../Gdk').Window, userData: Object | null): boolean;
/**
  ...
  */
export declare function windowInvalidateHandlerFunc(window: import('../Gdk').Window, region: import('../cairo').Region): void;
