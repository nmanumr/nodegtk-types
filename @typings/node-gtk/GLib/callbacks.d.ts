/**
  ...
  */
export declare function childWatchFunc(pid: number, status: number, userData: Object | null): void;
/**
  ...
  */
export declare function clearHandleFunc(handleId: number): void;
/**
  ...
  */
export declare function compareDataFunc(a: Object | null, b: Object | null, userData: Object | null): number;
/**
  * Specifies the type of a comparison function used to compare two values.  The function should return a negative integer if the first value comes before the second, 0 if they are equal, or a positive integer if the first value comes after the second.
  * @param a a value
  * @param b a value to compare with
  * @returns negative value if a < b; zero if a = b; positive value if a > b 
  */
export declare function compareFunc(a: Object | null, b: Object | null): number;
/**
  ...
  */
export declare function copyFunc(src: Object, data: Object | null): Object;
/**
  ...
  */
export declare function dataForeachFunc(keyId: number, data: Object | null, userData: Object | null): void;
/**
  ...
  * @param data the data element. 
  */
export declare function destroyNotify(data: Object | null): void;
/**
  ...
  */
export declare function duplicateFunc(data: Object | null, userData: Object | null): Object | null;
/**
  ...
  */
export declare function equalFunc(a: Object | null, b: Object | null): boolean;
/**
  ...
  */
export declare function freeFunc(data: Object | null): void;
/**
  ...
  */
export declare function func(data: Object | null, userData: Object | null): void;
/**
  ...
  */
export declare function hFunc(key: Object | null, value: Object | null, userData: Object | null): void;
/**
  ...
  */
export declare function hrFunc(key: Object | null, value: Object | null, userData: Object | null): boolean;
/**
  * Specifies the type of the hash function which is passed to g_hash_table_new() when a GLib.HashTable is created.
  * @param key a key
  * @returns the hash value corresponding to the key 
  */
export declare function hashFunc(key: Object | null): number;
/**
  ...
  */
export declare function hookCheckFunc(data: Object | null): boolean;
/**
  ...
  */
export declare function hookCheckMarshaller(hook: import('../GLib').Hook, marshalData: Object | null): boolean;
/**
  ...
  */
export declare function hookCompareFunc(newHook: import('../GLib').Hook, sibling: import('../GLib').Hook): number;
/**
  ...
  */
export declare function hookFinalizeFunc(hookList: import('../GLib').HookList, hook: import('../GLib').Hook): void;
/**
  ...
  */
export declare function hookFindFunc(hook: import('../GLib').Hook, data: Object | null): boolean;
/**
  * Defines the type of a hook function that can be invoked by GLib.HookList.invoke().
  * @param data the data field of the GLib.Hook is passed to the hook function here 
  */
export declare function hookFunc(data: Object | null): void;
/**
  * Defines the type of function used by g_hook_list_marshal().
  * @param hook a GLib.Hook
  * @param marshalData user data 
  */
export declare function hookMarshaller(hook: import('../GLib').Hook, marshalData: Object | null): void;
/**
  ...
  */
export declare function ioFunc(source: import('../GLib').IOChannel, condition: import('../GLib').IOCondition, data: Object | null): boolean;
/**
  ...
  */
export declare function logFunc(logDomain: string, logLevel: import('../GLib').LogLevelFlags, message: string, userData: Object | null): void;
/**
  ...
  */
export declare function logWriterFunc(logLevel: import('../GLib').LogLevelFlags, fields: import('../GLib').LogField, userData: Object | null): import('../GLib').LogWriterOutput;
/**
  ...
  */
export declare function nodeForeachFunc(node: import('../GLib').Node, data: Object | null): void;
/**
  ...
  */
export declare function nodeTraverseFunc(node: import('../GLib').Node, data: Object | null): boolean;
/**
  ...
  */
export declare function optionArgFunc(optionName: string, value: string, data: Object | null): boolean;
/**
  ...
  * @param data User data added to the GLib.OptionGroup containing the option when it was created with GLib.OptionGroup.new() 
  */
export declare function optionErrorFunc(context: import('../GLib').OptionContext, group: import('../GLib').OptionGroup, data: Object | null): void;
/**
  ...
  */
export declare function optionParseFunc(context: import('../GLib').OptionContext, group: import('../GLib').OptionGroup, data: Object | null): boolean;
/**
  ...
  */
export declare function pollFunc(ufds: import('../GLib').PollFD, nfsd: number, timeout: number): number;
/**
  ...
  */
export declare function printFunc(string: string): void;
/**
  ...
  */
export declare function regexEvalCallback(matchInfo: import('../GLib').MatchInfo, result: import('../GLib').String, userData: Object | null): boolean;
/**
  ...
  */
export declare function scannerMsgFunc(scanner: import('../GLib').Scanner, message: string, error: boolean): void;
/**
  ...
  */
export declare function sequenceIterCompareFunc(a: import('../GLib').SequenceIter, b: import('../GLib').SequenceIter, data: Object | null): number;
/**
  * This is just a placeholder for #GClosureMarshal, which cannot be used here for dependency reasons. 
  */
export declare function sourceDummyMarshal(): void;
/**
  ...
  */
export declare function sourceFunc(userData: Object | null): boolean;
/**
  ...
  */
export declare function spawnChildSetupFunc(userData: Object | null): void;
/**
  ...
  */
export declare function testDataFunc(userData: Object | null): void;
/**
  ...
  * @param userData the data provided when registering the test 
  */
export declare function testFixtureFunc(fixture: Object, userData: Object | null): void;
/**
  * The type used for test case functions. 
  */
export declare function testFunc(): void;
/**
  ...
  */
export declare function testLogFatalFunc(logDomain: string, logLevel: import('../GLib').LogLevelFlags, message: string, userData: Object | null): boolean;
/**
  ...
  */
export declare function threadFunc(data: Object | null): Object | null;
/**
  ...
  */
export declare function translateFunc(str: string, data: Object | null): string;
/**
  ...
  * @returns True to stop the traversal 
  */
export declare function traverseFunc(key: Object | null, value: Object | null, data: Object | null): boolean;
/**
  ...
  */
export declare function unixFdSourceFunc(fd: number, condition: import('../GLib').IOCondition, userData: Object | null): boolean;
/**
  ...
  */
export declare function voidFunc(): void;
