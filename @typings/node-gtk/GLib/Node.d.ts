...
/**
  ...
  */
next: import('../GLib').Node;
/**
  * points to the parent of the GLib.Node, or is None if the GLib.Node is the root of the tree. 
  */
parent: import('../GLib').Node;
/**
  * points to the node’s previous sibling. 
  */
prev: import('../GLib').Node;
}
