...
Gdk.Display.get_monitor_at_window(). 
  */
export declare class Monitor extends import('../GObject').Object{
/**
...
/**
  * The subpixel layout 
  */
subpixelLayout: import('../Gdk').SubpixelLayout;
/**
