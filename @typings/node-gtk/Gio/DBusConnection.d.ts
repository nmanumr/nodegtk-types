...
over any transport that can by represented as an Gio.IOStream. 
  */
export declare class DBusConnection extends import('../GObject').Object, import('../Gio').AsyncInitable, import('../Gio').Initable{
/**
...
/**
  * Capabilities 
  */
capabilities: import('../Gio').DBusCapabilityFlags;
/**
