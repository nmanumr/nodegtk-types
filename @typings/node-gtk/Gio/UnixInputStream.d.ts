...
to doing asynchronous I/O in another thread.) 
  */
export declare class UnixInputStream extends import('../Gio').InputStream, import('../Gio').FileDescriptorBased, import('../Gio').PollableInputStream{
/**
...
/**
  *   
  */
parentInstance: import('../Gio').InputStream;
}
