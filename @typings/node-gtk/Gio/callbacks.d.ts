/**
  ...
  */
export declare function asyncReadyCallback(sourceObject: import('../GObject').Object | null, res: import('../Gio').AsyncResult, userData: Object | null): void;
/**
  ...
  */
export declare function busAcquiredCallback(connection: import('../Gio').DBusConnection, name: string, userData: Object | null): void;
/**
  ...
  */
export declare function busNameAcquiredCallback(connection: import('../Gio').DBusConnection, name: string, userData: Object | null): void;
/**
  ...
  */
export declare function busNameAppearedCallback(connection: import('../Gio').DBusConnection, name: string, nameOwner: string, userData: Object | null): void;
/**
  ...
  * @param userData User data passed to Gio.bus_own_name() or Gio.bus_own_name_on_connection(). 
  */
export declare function busNameLostCallback(connection: import('../Gio').DBusConnection, name: string, userData: Object | null): void;
/**
  ...
  * @param userData User data passed to Gio.bus_watch_name(). 
  */
export declare function busNameVanishedCallback(connection: import('../Gio').DBusConnection, name: string, userData: Object | null): void;
/**
  ...
  */
export declare function cancellableSourceFunc(cancellable: import('../Gio').Cancellable | null, userData: Object | null): boolean;
/**
  ...
  */
export declare function dBusInterfaceGetPropertyFunc(connection: import('../Gio').DBusConnection, sender: string, objectPath: string, interfaceName: string, propertyName: string, error: import('../GLib').Error, userData: Object | null): import('../GLib').Variant;
/**
  ...
  * @param userData The user_data object passed to Gio.DBusConnection.register_object(). 
  */
export declare function dBusInterfaceMethodCallFunc(connection: import('../Gio').DBusConnection, sender: string, objectPath: string, interfaceName: string, methodName: string, parameters: import('../GLib').Variant, invocation: import('../Gio').DBusMethodInvocation, userData: Object | null): void;
/**
  ...
  */
export declare function dBusInterfaceSetPropertyFunc(connection: import('../Gio').DBusConnection, sender: string, objectPath: string, interfaceName: string, propertyName: string, value: import('../GLib').Variant, error: import('../GLib').Error, userData: Object | null): boolean;
/**
  ...
  */
export declare function dBusMessageFilterFunction(connection: import('../Gio').DBusConnection, message: import('../Gio').DBusMessage, incoming: boolean, userData: Object | null): import('../Gio').DBusMessage | null;
/**
  ...
  */
export declare function dBusProxyTypeFunc(manager: import('../Gio').DBusObjectManagerClient, objectPath: string, interfaceName: string | null, userData: Object | null): import('../GObject').GType;
/**
  ...
  */
export declare function dBusSignalCallback(connection: import('../Gio').DBusConnection, senderName: string, objectPath: string, interfaceName: string, signalName: string, parameters: import('../GLib').Variant, userData: Object | null): void;
/**
  ...
  */
export declare function dBusSubtreeDispatchFunc(connection: import('../Gio').DBusConnection, sender: string, objectPath: string, interfaceName: string, node: string, outUserData: Object, userData: Object | null): import('../Gio').DBusInterfaceVTable;
/**
  ...
  */
export declare function dBusSubtreeIntrospectFunc(connection: import('../Gio').DBusConnection, sender: string, objectPath: string, node: string, userData: Object | null): import('../Gio').DBusInterfaceInfo;
/**
  ...
  */
export declare function datagramBasedSourceFunc(datagramBased: import('../Gio').DatagramBased, condition: import('../GLib').IOCondition, userData: Object | null): boolean;
/**
  ...
  * @param userData User data 
  */
export declare function desktopAppLaunchCallback(appinfo: import('../Gio').DesktopAppInfo, pid: number, userData: Object | null): void;
/**
  ...
  */
export declare function fileMeasureProgressCallback(reporting: boolean, currentSize: number, numDirs: number, numFiles: number, userData: Object | null): void;
/**
  ...
  * @param userData user data passed to the callback. 
  */
export declare function fileProgressCallback(currentNumBytes: number, totalNumBytes: number, userData: Object | null): void;
/**
  ...
  */
export declare function fileReadMoreCallback(fileContents: string, fileSize: number, callbackData: Object | null): boolean;
/**
  * I/O Job function.
  ...
  */
export declare function ioSchedulerJobFunc(job: import('../Gio').IOSchedulerJob, cancellable: import('../Gio').Cancellable | null, userData: Object | null): boolean;
/**
  ...
  * @returns it should return False if the source should be removed. 
  */
export declare function pollableSourceFunc(pollableStream: import('../GObject').Object, userData: Object | null): boolean;
/**
  ...
  */
export declare function reallocFunc(data: Object | null, size: number): Object | null;
/**
  ...
  */
export declare function settingsBindGetMapping(value: import('../GObject').Value, variant: import('../GLib').Variant, userData: Object | null): boolean;
/**
  ...
  */
export declare function settingsBindSetMapping(value: import('../GObject').Value, expectedType: import('../GLib').VariantType, userData: Object | null): import('../GLib').Variant;
/**
  ...
  */
export declare function settingsGetMapping(value: import('../GLib').Variant, userData: Object | null): [boolean, Object];
/**
  ...
  * @param cancellable optional Gio.Cancellable object, None to ignore. 
  */
export declare function simpleAsyncThreadFunc(res: import('../Gio').SimpleAsyncResult, object: import('../GObject').Object, cancellable: import('../Gio').Cancellable | null): void;
/**
  ...
  * @returns it should return False if the source should be removed. 
  */
export declare function socketSourceFunc(socket: import('../Gio').Socket, condition: import('../GLib').IOCondition, userData: Object | null): boolean;
/**
  ...
  */
export declare function taskThreadFunc(task: import('../Gio').Task, sourceObject: import('../GObject').Object, taskData: Object | null, cancellable: import('../Gio').Cancellable | null): void;
/**
  ...
  */
export declare function vfsFileLookupFunc(vfs: import('../Gio').Vfs, identifier: string, userData: Object | null): import('../Gio').File;
