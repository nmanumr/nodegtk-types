...
implement client-side and server-side DTLS, respectively. 
  */
export declare interface DtlsConnection extends import('../GObject').GInterface{
/**
...
/**
  ...
  */
peerCertificate: import('../Gio').TlsCertificate;
/**
  * Errors found with the peer’s certificate 
  */
peerCertificateErrors: import('../Gio').TlsCertificateFlags;
/**
