export declare function accelGroupActivate(accelGroup: import('../Gtk').AccelGroup, acceleratable: import('../GObject').Object, keyval: number, modifier: import('../Gdk').ModifierType): boolean;
export declare function accelGroupFindFunc(key: import('../Gtk').AccelKey, closure: import('../GObject').Closure, data: Object | null): boolean;
/**
  * 
  ...
  */
export declare function accelMapForeach(data: Object | null, accelPath: string, accelKey: number, accelMods: import('../Gdk').ModifierType, changed: boolean): void;
/**
  ...
  */
export declare function assistantPageFunc(currentPage: number, data: Object | null): number;
/**
  ...
  */
export declare function builderConnectFunc(builder: import('../Gtk').Builder, object: import('../GObject').Object, signalName: string, handlerName: string, connectObject: import('../GObject').Object | null, flags: import('../GObject').ConnectFlags, userData: Object | null): void;
/**
  ...
  */
export declare function calendarDetailFunc(calendar: import('../Gtk').Calendar, year: number, month: number, day: number, userData: Object | null): string | null;
/**
  ...
  */
export declare function callback(widget: import('../Gtk').Widget, data: Object | null): void;
/**
  ...
  */
export declare function cellAllocCallback(renderer: import('../Gtk').CellRenderer, cellArea: import('../Gdk').Rectangle, cellBackground: import('../Gdk').Rectangle, data: Object | null): boolean;
/**
  ...
  * @returns True to stop iterating over cells. 
  */
export declare function cellCallback(renderer: import('../Gtk').CellRenderer, data: Object | null): boolean;
/**
  ...
  */
export declare function cellLayoutDataFunc(cellLayout: import('../Gtk').CellLayout, cell: import('../Gtk').CellRenderer, treeModel: import('../Gtk').TreeModel, iter: import('../Gtk').TreeIter, data: Object | null): void;
/**
  ...
  */
export declare function clipboardClearFunc(clipboard: import('../Gtk').Clipboard, userDataOrOwner: Object | null): void;
/**
  ...
  * @param userDataOrOwner the user_data argument passed to gtk_clipboard_set_with_data(), or the owner argument passed to gtk_clipboard_set_with_owner() 
  */
export declare function clipboardGetFunc(clipboard: import('../Gtk').Clipboard, selectionData: import('../Gtk').SelectionData, info: number, userDataOrOwner: Object | null): void;
/**
  ...
  */
export declare function clipboardImageReceivedFunc(clipboard: import('../Gtk').Clipboard, pixbuf: import('../GdkPixbuf').Pixbuf, data: Object | null): void;
/**
  ...
  */
export declare function clipboardReceivedFunc(clipboard: import('../Gtk').Clipboard, selectionData: import('../Gtk').SelectionData, data: Object | null): void;
/**
  ...
  */
export declare function clipboardRichTextReceivedFunc(clipboard: import('../Gtk').Clipboard, format: import('../Gdk').Atom, text: string | null, length: number, data: Object | null): void;
/**
  ...
  */
export declare function clipboardTargetsReceivedFunc(clipboard: import('../Gtk').Clipboard, atoms: import('../Gdk').Atom | null, data: Object | null): void;
/**
  ...
  */
export declare function clipboardTextReceivedFunc(clipboard: import('../Gtk').Clipboard, text: string | null, data: Object | null): void;
/**
  ...
  */
export declare function clipboardUriReceivedFunc(clipboard: import('../Gtk').Clipboard, uris: string, data: Object | null): void;
/**
  * 
  * @param colors Array of colors 
  */
export declare function colorSelectionChangePaletteFunc(colors: import('../Gdk').Color): void;
/**
  * 
  * @param colors Array of colors 
  */
export declare function colorSelectionChangePaletteWithScreenFunc(screen: import('../Gdk').Screen, colors: import('../Gdk').Color): void;
/**
  ...
  */
export declare function entryCompletionMatchFunc(completion: import('../Gtk').EntryCompletion, key: string, iter: import('../Gtk').TreeIter, userData: Object | null): boolean;
/**
  ...
  */
export declare function fileFilterFunc(filterInfo: import('../Gtk').FileFilterInfo, data: Object | null): boolean;
/**
  ...
  */
export declare function flowBoxCreateWidgetFunc(item: import('../GObject').Object, userData: Object | null): import('../Gtk').Widget;
/**
  ...
  */
export declare function flowBoxFilterFunc(child: import('../Gtk').FlowBoxChild, userData: Object | null): boolean;
/**
  ...
  * @param userData user data 
  */
export declare function flowBoxForeachFunc(box: import('../Gtk').FlowBox, child: import('../Gtk').FlowBoxChild, userData: Object | null): void;
/**
  ...
  */
export declare function flowBoxSortFunc(child1: import('../Gtk').FlowBoxChild, child2: import('../Gtk').FlowBoxChild, userData: Object | null): number;
/**
  ...
  */
export declare function fontFilterFunc(family: import('../Pango').FontFamily, face: import('../Pango').FontFace, data: Object | null): boolean;
/**
  ...
  * @param data user data 
  */
export declare function iconViewForeachFunc(iconView: import('../Gtk').IconView, path: import('../Gtk').TreePath, data: Object | null): void;
/**
  ...
  */
export declare function keySnoopFunc(grabWidget: import('../Gtk').Widget, event: import('../Gdk').EventKey, funcData: Object | null): number;
/**
  ...
  * @returns a Gtk.Widget that represents item 
  */
export declare function listBoxCreateWidgetFunc(item: import('../GObject').Object, userData: Object | null): import('../Gtk').Widget;
/**
  ...
  * @returns True if the row should be visible, False otherwise 
  */
export declare function listBoxFilterFunc(row: import('../Gtk').ListBoxRow, userData: Object | null): boolean;
/**
  ...
  * @param userData user data 
  */
export declare function listBoxForeachFunc(box: import('../Gtk').ListBox, row: import('../Gtk').ListBoxRow, userData: Object | null): void;
/**
  ...
  */
export declare function listBoxSortFunc(row1: import('../Gtk').ListBoxRow, row2: import('../Gtk').ListBoxRow, userData: Object | null): number;
/**
  ...
  * @param userData user data 
  */
export declare function listBoxUpdateHeaderFunc(row: import('../Gtk').ListBoxRow, before: import('../Gtk').ListBoxRow | null, userData: Object | null): void;
/**
  ...
  */
export declare function menuDetachFunc(attachWidget: import('../Gtk').Widget, menu: import('../Gtk').Menu): void;
/**
  ...
  */
export declare function menuPositionFunc(menu: import('../Gtk').Menu, x: number, y: number, userData: Object | null): [number, number, boolean];
/**
  ...
  */
export declare function moduleDisplayInitFunc(display: import('../Gdk').Display): void;
/**
  ...
  */
export declare function moduleInitFunc(argv: string | null): void;
/**
  ...
  */
export declare function pageSetupDoneFunc(pageSetup: import('../Gtk').PageSetup, data: Object | null): void;
export declare function printSettingsFunc(key: string, value: string, userData: Object | null): void;
export declare function rcPropertyParser(pspec: import('../GObject').ParamSpec, rcString: import('../GLib').String, propertyValue: import('../GObject').Value): boolean;
/**
  ...
  * @returns True if the file should be displayed 
  */
export declare function recentFilterFunc(filterInfo: import('../Gtk').RecentFilterInfo, userData: Object | null): boolean;
export declare function recentSortFunc(a: import('../Gtk').RecentInfo, b: import('../Gtk').RecentInfo, userData: Object | null): number;
export declare function stylePropertyParser(string: string, value: import('../GObject').Value): boolean;
/**
  ...
  */
export declare function textBufferDeserializeFunc(registerBuffer: import('../Gtk').TextBuffer, contentBuffer: import('../Gtk').TextBuffer, iter: import('../Gtk').TextIter, data: Int8Array, createTags: boolean, userData: Object | null): boolean;
/**
  ...
  */
export declare function textBufferSerializeFunc(registerBuffer: import('../Gtk').TextBuffer, contentBuffer: import('../Gtk').TextBuffer, start: import('../Gtk').TextIter, end: import('../Gtk').TextIter, length: number, userData: Object | null): number | null;
export declare function textCharPredicate(ch: string, userData: Object | null): boolean;
/**
  * 
  * @param tag the Gtk.TextTag
  * @param data data passed to Gtk.TextTagTable.foreach() 
  */
export declare function textTagTableForeach(tag: import('../Gtk').TextTag, data: Object | null): void;
/**
  ...
  */
export declare function tickCallback(widget: import('../Gtk').Widget, frameClock: import('../Gdk').FrameClock, userData: Object | null): boolean;
/**
  ...
  */
export declare function translateFunc(path: string, funcData: Object | null): string;
/**
  ...
  * @param data user data 
  */
export declare function treeCellDataFunc(treeColumn: import('../Gtk').TreeViewColumn, cell: import('../Gtk').CellRenderer, treeModel: import('../Gtk').TreeModel, iter: import('../Gtk').TreeIter, data: Object | null): void;
export declare function treeDestroyCountFunc(treeView: import('../Gtk').TreeView, path: import('../Gtk').TreePath, children: number, userData: Object | null): void;
/**
  ...
  */
export declare function treeIterCompareFunc(model: import('../Gtk').TreeModel, a: import('../Gtk').TreeIter, b: import('../Gtk').TreeIter, userData: Object | null): number;
/**
  ...
  */
export declare function treeModelFilterModifyFunc(model: import('../Gtk').TreeModel, iter: import('../Gtk').TreeIter, column: number, data: Object | null): import('../GObject').Value;
/**
  ...
  */
export declare function treeModelFilterVisibleFunc(model: import('../Gtk').TreeModel, iter: import('../Gtk').TreeIter, data: Object | null): boolean;
/**
  ...
  */
export declare function treeModelForeachFunc(model: import('../Gtk').TreeModel, path: import('../Gtk').TreePath, iter: import('../Gtk').TreeIter, data: Object | null): boolean;
/**
  ...
  * @param data user data 
  */
export declare function treeSelectionForeachFunc(model: import('../Gtk').TreeModel, path: import('../Gtk').TreePath, iter: import('../Gtk').TreeIter, data: Object | null): void;
/**
  ...
  */
export declare function treeSelectionFunc(selection: import('../Gtk').TreeSelection, model: import('../Gtk').TreeModel, path: import('../Gtk').TreePath, pathCurrentlySelected: boolean, data: Object | null): boolean;
/**
  ...
  */
export declare function treeViewColumnDropFunc(treeView: import('../Gtk').TreeView, column: import('../Gtk').TreeViewColumn, prevColumn: import('../Gtk').TreeViewColumn, nextColumn: import('../Gtk').TreeViewColumn, data: Object | null): boolean;
/**
  ...
  * @param userData user data 
  */
export declare function treeViewMappingFunc(treeView: import('../Gtk').TreeView, path: import('../Gtk').TreePath, userData: Object | null): void;
/**
  ...
  */
export declare function treeViewRowSeparatorFunc(model: import('../Gtk').TreeModel, iter: import('../Gtk').TreeIter, data: Object | null): boolean;
/**
  ...
  */
export declare function treeViewSearchEqualFunc(model: import('../Gtk').TreeModel, column: number, key: string, iter: import('../Gtk').TreeIter, searchData: Object | null): boolean;
export declare function treeViewSearchPositionFunc(treeView: import('../Gtk').TreeView, searchDialog: import('../Gtk').Widget, userData: Object | null): void;
