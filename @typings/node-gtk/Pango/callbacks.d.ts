/**
  ...
  */
export declare function attrDataCopyFunc(userData: Object | null): Object | null;
/**
  ...
  */
export declare function attrFilterFunc(attribute: import('../Pango').Attribute, userData: Object | null): boolean;
/**
  ...
  */
export declare function fontsetForeachFunc(fontset: import('../Pango').Fontset, font: import('../Pango').Font, userData: Object | null): boolean;
